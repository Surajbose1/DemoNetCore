...
namespace DempApp.Data.Migrations
{
    ...
    [Migration("20200520063247_ConfigureDBRelations_ManytoMany")]
    partial class ConfigureDBRelations_ManytoMany
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DempApp.Data.Models.ConfigureDBRelations+Author", b =>
                {
            ...
            modelBuilder.Entity("DempApp.Data.Models.ConfigureDBRelations+AuthorBiography", b =>
                {
            ...
            modelBuilder.Entity("DempApp.Data.Models.ConfigureDBRelations+Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DempApp.Data.Models.ConfigureDBRelations+Employee", b =>
                {
                    b.HasOne("DempApp.Data.Models.ConfigureDBRelations+Company", "Company")
                        .WithMany("Employees")
